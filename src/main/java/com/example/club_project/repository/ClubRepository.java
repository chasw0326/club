...
public interface ClubRepository extends JpaRepository<Club, Long> {
    ...
    @Query("select c from Club c join fetch c.category where c.id = :id")
    ...
    List<Club> findAll(@Param("categories") List<Category> categories, @Param("university") String university, Pageable pageable);
